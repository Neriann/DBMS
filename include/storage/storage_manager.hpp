...
private:
    ...
    [[nodiscard]] fs::path history_path(const std::string &db_name, const std::string &table_name) const;
    ...
    void write_table_history(const std::string &db_name, const std::string &table_name, const Table &table) const;
